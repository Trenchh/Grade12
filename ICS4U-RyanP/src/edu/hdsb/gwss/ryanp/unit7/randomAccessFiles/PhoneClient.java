...
//        RandomAccessFile raf = new RandomAccessFile("size.dat", "rw");
//        raf.writeChars(phone1.getName());
//        raf.writeInt(phone1.getStorage());
//        raf.writeDouble(phone1.getPrice());
//        raf.writeChars(phone1.getOS());
//        raf.writeChars(phone1.getCarrier());
//        raf.writeInt(phone1.getRating());
//        raf.writeBoolean(phone1.isUnlocked());
